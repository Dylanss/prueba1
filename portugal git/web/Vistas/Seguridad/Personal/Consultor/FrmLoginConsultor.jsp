...
<html>
  ...
  <body>
    ...
    <div class="login-caja">
      <img src="<%=request.getContextPath()%>/imagenes/informes.png" class="avatar" alt="">
      ...
      <form>
        ...
        <input type="submit" value="Ingresar" onclick="ingresar('<%=request.getContextPath()%>','ConsultorServlet',3)">
        <input type="submit" value="Volver" onclick="salirconsultor()">
